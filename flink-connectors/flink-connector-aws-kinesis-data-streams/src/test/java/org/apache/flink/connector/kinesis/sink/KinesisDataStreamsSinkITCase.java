...
public class KinesisDataStreamsSinkITCase extends TestLogger {
    ...
    private final KinesisDataStreamsSinkElementConverter.PartitionKeyGenerator<String>
            partitionKeyGenerator = element -> String.valueOf(element.hashCode());
    private final KinesisDataStreamsSinkElementConverter.PartitionKeyGenerator<String>
            longPartitionKeyGenerator = element -> element;
    ...
    private class Scenario {
        ...
        private KinesisDataStreamsSinkElementConverter.PartitionKeyGenerator<String>
                partitionKeyGenerator = KinesisDataStreamsSinkITCase.this.partitionKeyGenerator;
        ...
        public Scenario withPartitionKeyGenerator(
                KinesisDataStreamsSinkElementConverter.PartitionKeyGenerator<String>
