...
public class KinesisDataStreamsSinkBuilderTest {
    ...
    private static final KinesisDataStreamsSinkElementConverter.PartitionKeyGenerator<String>
            PARTITION_KEY_GENERATOR = element -> String.valueOf(element.hashCode());
