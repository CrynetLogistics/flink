...
public class AwsV2UtilTest {
    ...
    public void testGetCredentialsProviderAssumeRole() {
        ...
        verify(properties).getProperty(roleArn(AWS_CREDENTIALS_PROVIDER));
        verify(properties).getProperty(roleSessionName(AWS_CREDENTIALS_PROVIDER));
    ...
    public void testCreateNettyHttpClientWithDefaults() {
        ...
        verify(builder).tcpKeepAlive(false);
