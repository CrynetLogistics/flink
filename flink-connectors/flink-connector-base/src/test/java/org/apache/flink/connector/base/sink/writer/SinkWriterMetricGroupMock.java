...
class SinkWriterMetricGroupMock implements SinkWriterMetricGroup {

    private Gauge<Long> currentSendTimeGauge;
    private final OperatorIOMetricGroup operatorIOMetricGroup = new OperatorIOMetricGroupMock();
    ...
    public void setCurrentSendTimeGauge(Gauge<Long> gauge) {
        this.currentSendTimeGauge = gauge;
    }
